        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 text-center">
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{ route('web.theme.home') }}">Home <i
                                    class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a
                                href="{{ route('web.theme.blog') }}">Blog <i class="ion-ios-arrow-forward"></i></a></span>
                        <span>Blog Single <i
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 order-md-last ftco-animate">
                    ...
                    <p>
                        <img src="{{ asset('images/web/theme/image_7.jpg') }}" alt="" class="img-fluid">
                    </p>
                    ...
                    <p>
                        <img src="{{ asset('images/web/theme/image_8.jpg') }}" alt="" class="img-fluid">
                    </p>
                    ...
                    <div class="about-author d-flex p-4 bg-light">
                        <div class="bio mr-5">
                            <img src="{{ asset('images/web/theme/person_1.jpg') }}" alt="Image placeholder"
                        ...
                        <ul class="comment-list">
                            ...
                            <li class="comment">
                                ...
                                <ul class="children">
                                    <li class="comment">
                                        <div class="vcard bio">
                                            <img src="{{ asset('images/web/theme/person_1.jpg') }}"
