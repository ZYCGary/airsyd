          ...
          <table class="table table-sm table-striped">
            <thead>
              <tr>
                ...
                <th>User_id</th> <th>Accommodation</th> <th>Type</th> <th>Street</th> <th>Suburb</th> <th>City</th> <th>Total_bedrooms</th> <th>Total_bathrooms</th> <th>Max_load</th> <th>Rooms</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$property->user_id}}</td> <td>{{$property->accommodation}}</td> <td>{{$property->type}}</td> <td>{{$property->street}}</td> <td>{{$property->suburb}}</td> <td>{{$property->city}}</td> <td>{{$property->total_bedrooms}}</td> <td>{{$property->total_bathrooms}}</td> <td>{{$property->max_load}}</td> <td>{{$property->rooms}}</td>
