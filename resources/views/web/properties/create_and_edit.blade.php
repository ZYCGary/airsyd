      ...
      <div class="card-body">
        ...
        @endif
          ...
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="form-group">
                    <label for="accommodation-field">Accommodation</label>
                    <input class="form-control" type="text" name="accommodation" id="accommodation-field" value="{{ old('accommodation', $property->accommodation ) }}" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                	...
                	<input class="form-control" type="text" name="city" id="city-field" value="{{ old('city', $property->city ) }}" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="rooms-field">Rooms</label>
                    <input class="form-control" type="text" name="rooms" id="rooms-field" value="{{ old('rooms', $property->rooms ) }}" />
                </div>
